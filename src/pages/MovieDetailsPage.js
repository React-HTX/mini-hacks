  ...
  return (
    <div>
        ...
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
          ...
          <div>
            ...
            <div className="flex space-x-2 mb-2">
              <p className="text-black bg-red-500 text-white font-semibold py-2 px-4 rounded">
            ...
            <div>
              <p>
                {movieDetails.genres.map((genre) => (
                  <span
                    className="bg-yellow-500 text-white font-semibold py-2 px-4 rounded mr-2 mb-2"
                    key={genre.id}
                  >
                    {genre.name}
                  </span>
      ...
      <div className="flex bg-white min-h-screen flex-col items-center justify-between p-24">
        <h2 className="flex text-black text-2xl font-semibold">
          Similiar Movies
        </h2>
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
